from utils import color_map, min_max_normalisation, mae
...
class Registration_Obj():
    ...
    def map_pcd(self, method,unmapped='knn',knn_radius=5):
...
def nn_average(search_radius, average_type = 'Median'):
    
    for source_index in range(len(self.source_pcd)):
        pcd_tree = o3d.geometry.KDTreeFlann(self.source_pcd[source_index])
